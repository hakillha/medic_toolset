...
def gen_slice_dataset(data_dir, out_dir, multicat, discard_neg, min_ct_1ch, 
    max_ct_1ch, norm_by_interval, include_healthy, thickness_thres, num_cpu=8):
    info_paths = get_infos(data_dir)
    ...
    extract = partial(extract_slice_single_file, 
        out_dir=out_dir, min_ct_1ch=min_ct_1ch, max_ct_1ch=max_ct_1ch, multicat=multicat, 
        discard_neg=discard_neg, norm_by_interval=norm_by_interval, include_healthy=include_healthy, 
        thickness_thres=thickness_thres)
...
def parse_args():
    ...
    parser.add_argument("--data_dir",
        ...
        default="/rdfs/fast/home/sunyingge/data/COV_19/0508/TestSet/healthy_with_id"
        )
    parser.add_argument("--data_dir_suffix", nargs='+', 
        help="""This is added to the ends of both "--data_dir" and "--out_dir".""",
        default=[""] # This lets the script directly use "--data_dir"
...
if __name__ == "__main__":
    ...
    for sfx in args.data_dir_suffix:
        gen_slice_dataset(pj(args.data_dir, sfx), args.out_dir, args.multicat, args.discard_neg, 
